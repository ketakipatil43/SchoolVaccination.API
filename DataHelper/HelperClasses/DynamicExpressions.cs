...
namespace DataHelper.HelperClasses
{
    ...
    public static class PredicateBuilder
    {
        ...
        class ParameterRebinder : ExpressionVisitor
        {
            ...
            public static Expression ReplaceParameters(Dictionary<ParameterExpression, ParameterExpression> map, Expression node)
            {
                return new ParameterRebinder(map).Visit(node);
            }
